...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        class and object id
        """
        storage.new(Product(id='54321f01-f641', name='Goat'))
        storage.save()
    ...
    def test_delete(self):
        ...
        """
        storage.new(Product(name='Tomato'))
